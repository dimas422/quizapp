...
func (_c *UserCreate) AddQuizIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddQuizIDs(ids...)
	return _c
}

// AddQuizzes adds the "quizzes" edges to the Quiz entity.
func (_c *UserCreate) AddQuizzes(v ...*Quiz) *UserCreate {
...
func (_c *UserCreate) AddAttemptIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddAttemptIDs(ids...)
	return _c
}

// AddAttempts adds the "attempts" edges to the Attempt entity.
func (_c *UserCreate) AddAttempts(v ...*Attempt) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
