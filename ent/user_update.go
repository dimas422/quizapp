...
func (_u *UserUpdate) AddQuizIDs(ids ...uuid.UUID) *UserUpdate {
	_u.mutation.AddQuizIDs(ids...)
	return _u
}

// AddQuizzes adds the "quizzes" edges to the Quiz entity.
func (_u *UserUpdate) AddQuizzes(v ...*Quiz) *UserUpdate {
...
func (_u *UserUpdate) AddAttemptIDs(ids ...uuid.UUID) *UserUpdate {
	_u.mutation.AddAttemptIDs(ids...)
	return _u
}

// AddAttempts adds the "attempts" edges to the Attempt entity.
func (_u *UserUpdate) AddAttempts(v ...*Attempt) *UserUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddQuizIDs adds the "quizzes" edge to the Quiz entity by IDs.
func (_u *UserUpdateOne) AddQuizIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.AddQuizIDs(ids...)
	return _u
}

// AddQuizzes adds the "quizzes" edges to the Quiz entity.
func (_u *UserUpdateOne) AddQuizzes(v ...*Quiz) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddAttemptIDs adds the "attempts" edge to the Attempt entity by IDs.
func (_u *UserUpdateOne) AddAttemptIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.AddAttemptIDs(ids...)
	return _u
}

// AddAttempts adds the "attempts" edges to the Attempt entity.
func (_u *UserUpdateOne) AddAttempts(v ...*Attempt) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearQuizzes clears all "quizzes" edges to the Quiz entity.
func (_u *UserUpdateOne) ClearQuizzes() *UserUpdateOne {
	_u.mutation.ClearQuizzes()
	return _u
}

// RemoveQuizIDs removes the "quizzes" edge to Quiz entities by IDs.
func (_u *UserUpdateOne) RemoveQuizIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.RemoveQuizIDs(ids...)
	return _u
}

// RemoveQuizzes removes "quizzes" edges to Quiz entities.
func (_u *UserUpdateOne) RemoveQuizzes(v ...*Quiz) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAttempts clears all "attempts" edges to the Attempt entity.
func (_u *UserUpdateOne) ClearAttempts() *UserUpdateOne {
	_u.mutation.ClearAttempts()
	return _u
}

// RemoveAttemptIDs removes the "attempts" edge to Attempt entities by IDs.
func (_u *UserUpdateOne) RemoveAttemptIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.RemoveAttemptIDs(ids...)
	return _u
}

// RemoveAttempts removes "attempts" edges to Attempt entities.
func (_u *UserUpdateOne) RemoveAttempts(v ...*Attempt) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
